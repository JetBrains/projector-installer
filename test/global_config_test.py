...
from projector_installer.global_config import get_changelog_url, get_path_to_license, \
    get_apps_dir, get_run_configs_dir, get_ssl_properties_file, get_download_cache_dir, \
    get_ssl_dir, get_projector_server_dir
...
class GlobalConfigTest(TestCase):
    ...
    def test_get_path_to_license(self):
        """The get_path_to_license method must return full path to LICENSE.txt file"""
        path_to_license = f'{self.user}/PycharmProjects/projector-installer' \
                          f'/projector_installer/LICENSE.txt'
    ...
    def test_get_projector_server_dir(self):
        """The get_projector_server_dir method must return full path \
                        to projector server's directory"""
        projector_server_dir = f'{self.user}/PycharmProjects/projector-installer' \
                               f'/projector_installer/bundled/server'
